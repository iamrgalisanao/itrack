        ...
        <>
          ...
          <Collapsible open={isTableOpen} onOpenChange={setIsTableOpen}>
            <div className="relative rounded-xl border border-border shadow-sm overflow-hidden">
              ...
              <div className="relative flex w-full items-center py-3 border-b border-border bg-muted/30">
          ...
          {sessionDetail.vote_summary && (
            <div className="flex items-center gap-6 rounded-lg border border-border bg-card px-4 py-2.5 text-xs font-medium text-muted-foreground">
            ...
            <TabsContent value="comments" className="space-y-3">
              ...
              <div className="max-h-64 overflow-y-auto space-y-2">
                ...
                {entryComments.map((comment) => (
                  <div key={comment.id} className="rounded-md border border-border bg-card p-2.5 text-sm">
            ...
            <TabsContent value="files" className="space-y-3">
              ...
              <div className="max-h-64 overflow-y-auto space-y-2">
                ...
                {entryAttachments.map((attachment) => (
                  <div key={attachment.id} className="flex items-center justify-between rounded-md border border-border bg-card p-2.5 text-sm">
