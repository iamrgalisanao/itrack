...
- `/speckit-tasks` and `/speckit-implement` MUST refuse to proceed against a plan.md missing that section or recording anything other than `PASSED` — see speckit-implement's precondition check
