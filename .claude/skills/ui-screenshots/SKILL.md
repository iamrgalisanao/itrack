...
1. **Always capture the before state BEFORE making any changes** — if you forget, you have to revert code to get a before shot
...
Adapted from [github/awesome-copilot](https://github.com/github/awesome-copilot), `skills/ui-screenshots/`.
